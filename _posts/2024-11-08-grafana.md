...
1부 [Kubernetes 리소스 모니터링(1) - Prometheus](https://kkamji.net/posts/prometheus/)에 이어서 이번 시간에는 **Grafana**의 개념과 Helm을 사용한 구축 방법에 대해 다뤄보도록 하겠습니다.

## Grafana란?

**Grafana**는 오픈 소스 데이터 시각화 및 모니터링 플랫폼으로, 이를 사용해 **다양한 데이터 소스에서 수집된 데이터를 기반으로 대시보드와 차트를 생성하여 실시간으로 모니터링**할 수 있습니다. Grafana는 Metric, Log, Trace 등 다양한 형태의 데이터를 지원하며, 시스템 상태를 한눈에 파악하기 쉽도록 사용자 친화적인 인터페이스와 강력한 기능을 제공하고 있습니다.
...
![Grafana Main](/assest/img/grafana/grafana_main.webp)
