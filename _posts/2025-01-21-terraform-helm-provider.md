...
> `terraform` 명령어를 실행하는 환경에서 `~/.kube/config` 경로의 kubeconfig 파일이 정상적으로 Kubernetes 클러스터에 접근할 수 있어야 합니다.
{: .prompt-tip}
...
### 2. Kubernetes Cluster Credentials 사용
