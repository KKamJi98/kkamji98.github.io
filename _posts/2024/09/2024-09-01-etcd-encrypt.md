...
{% include diagrams/static/kubernetes/etcd-secret-encryption.html %}
{% include diagrams/download.html png="/assets/img/diagrams/static/kubernetes/etcd-secret-encryption--a336c32cdc4a8cad.png" %}
...
type: Opaque
data:
  test_secret: <BASE64_ENCRYPTION_SECRET>
```
  ...
  - resources:
    ...
    providers:
      - aescbc:
          keys:
            - name: key1
              secret: <BASE64_ENCRYPTION_SECRET>
      - identity: {}
```
...
type: Opaque
data:
  test_secret2: <BASE64_SECRET_VALUE>
```
