...
-- 통합 리팩터: 성능, UX 강화, Ctrl+/ 주석, 탐색/진단 UI 포함
...
require("lazy").setup({
  ...
  -- Ctrl+/ 주석 토글
  {
    ...
    config = function()
      ...
      vim.keymap.set("n", "<C-_>", function() api.toggle.linewise.current() end, { noremap = true, silent = true })
      vim.keymap.set("x", "<C-_>", function() api.toggle.linewise(vim.fn.visualmode()) end, { noremap = true, silent = true })
    end,
  },
  ...
  -- Mason LSP bridge
  {
    ...
    config = function()
      -- 0.10 호환: 자동 활성화 끔 (0.11+이면 true로 변경 가능)
  ...
  -- LSP 설정
  {
    ...
    config = function()
      ...
      local on_attach = function(_, bufnr)
        local buf = function(mode, lhs, rhs)
  ...
  -- 진단 패널
  {
    ...
    dependencies = { "nvim-tree/nvim-web-devicons" },
    keys = {
      { "<leader>xx", "<cmd>Trouble diagnostics toggle<CR>", { silent = true } },
      { "<leader>xq", "<cmd>Trouble qflist toggle<CR>",      { silent = true } },
    },
    opts = {},
  },
  ...
  -- 세션 복원
  {
    ...
    config = true,
    keys = {
      { "<leader>ss", function() require("persistence").load() end,                { silent = true } },
      { "<leader>sl", function() require("persistence").load({ last = true }) end, { silent = true } },
      { "<leader>sd", function() require("persistence").stop() end,                { silent = true } },
    },
  },
})
