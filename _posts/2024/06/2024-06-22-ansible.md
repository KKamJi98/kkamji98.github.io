...
{% include diagrams/static/iac/ansible-control-flow.html %}
{% include diagrams/download.html png="/assets/img/diagrams/static/iac/ansible-control-flow--a7d1c9eaa0311b6c.png" %}
