...
3. [Kubernetes 리소스 모니터링 (3) - Prometheus & Grafana 연동 (현재 글)]({% post_url 2024/11/2024-11-09-prometheus-grafana %})
...
- [prometheus-server.monitoring.svc.cluster.local:9090` - Home](http://prometheus-server.monitoring.svc.cluster.local:9090`)
