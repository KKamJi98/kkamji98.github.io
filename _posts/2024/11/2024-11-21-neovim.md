...
**Neovim**을 간단히 소개하고, 플러그인 매니저인 **lazy.nvim**과 아름다운 테마인 **tokyonight**를 연계하여 깔끔한 개발 환경을 만드는 방법을 다룹니다. 추가로, 위에서 제시한 설정 파일(`init.lua`)을 바탕으로 설정 방법을 간략히 정리하겠습니다.

---

## 1. Neovim이란?

**Neovim**은 Vim의 발전형 에디터로, Vimscript에 비해 더욱 현대적인 확장성과 성능을 제공합니다. 특히 Lua 언어를 통한 설정과 플러그인 관리, 그리고 내장 LSP 클라이언트 지원 등을 통해 IDE급 개발 환경을 쉽게 구축할 수 있습니다. 전통적인 Vim 사용자들에게는 익숙한 키 바인딩과 기능을 이어받으면서도, 새로운 유저에게는 간결한 설정 파일 구조와 강력한 플러그인 생태계를 통해 강력한 편의성을 제공합니다.
...
- **속도 최적화**: Neovim 시작 시 불필요한 플러그인 로드를 최소화하고, 이벤트나 조건에 따른 지연 로딩(load)을 지원  
...
1. [Neovim 환경 구축하기 - lazy.nvim, tokyonight 테마 설정 (현재 글)]({% post_url 2024/11/2024-11-21-neovim %})

---

## 7. Reference

- [Neovim Docs - Official Site](https://neovim.io)
- [GitHub - lazy.nvim](https://github.com/folke/lazy.nvim)
- [GitHub - tokyonight.nvim](https://github.com/folke/tokyonight.nvim)
- [GitHub - nvim-tree](https://github.com/nvim-tree/nvim-tree.lua)
- [GitHub - lualine.nvim](https://github.com/nvim-lualine/lualine.nvim)
- [GitHub - telescope.nvim](https://github.com/nvim-telescope/telescope.nvim)
- [GitHub - telescope-fzf-native](https://github.com/nvim-telescope/telescope-fzf-native.nvim)
- [GitHub - gitsigns.nvim](https://github.com/lewis6991/gitsigns.nvim)
- [GitHub - indent-blankline.nvim(ibl)](https://github.com/lukas-reineke/indent-blankline.nvim)
- [GitHub - todo-comments.nvim](https://github.com/folke/todo-comments.nvim)
- [GitHub - fidget.nvim](https://github.com/j-hui/fidget.nvim)
