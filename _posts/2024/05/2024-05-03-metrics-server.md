...
{% include diagrams/static/kubernetes/metrics-server-collection.html %}
{% include diagrams/download.html png="/assets/img/diagrams/static/kubernetes/metrics-server-collection--461837561eb44b6c.png" %}
_Metrics API에서 갈라지는 두 화살표는 순서가 아니라 같은 API를 읽는 두 소비자다. HPA 컨트롤러와 kubectl top은 서로를 거치지 않는다._
