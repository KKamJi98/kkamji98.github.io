...
{% include diagrams/static/ci-cd/ec2-jenkins-server-flow.html %}
{% include diagrams/download.html png="/assets/img/diagrams/static/ci-cd/ec2-jenkins-server-flow--490d33faac158835.png" %}
