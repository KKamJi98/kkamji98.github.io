...
{% include diagrams/static/kubernetes/microk8s-worker-join.html %}
{% include diagrams/download.html png="/assets/img/diagrams/static/kubernetes/microk8s-worker-join--5bd609b07fe4f919.png" %}
