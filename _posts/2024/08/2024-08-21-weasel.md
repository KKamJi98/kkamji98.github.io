...
**Weasel** 프로젝트는 **Bedrock Claude Sonnet 3.5 Model**을 사용한 문제풀이 서비스로, **Frontend 2명, Backend 2명, Infra 2명, 총 6명**으로 진행하였고, 저는 인프라를 담당했습니다. 처음 팀장으로서 프로젝트를 진행하며 내가 잘할 수 있을지 걱정이 되었지만, 팀원들 덕분에 직면한 문제를 수월하게 해결할 수 있었습니다. **Weasel** 프로젝트에 대해 소개하고, 트러블슈팅과 느낀 점을 다룹니다.

> **TL;DR**  
> - 6명이 진행한 Weasel 프로젝트를 마무리했고, 인프라를 담당했습니다.  
> - 프로젝트의 주요 기능, 인프라 구성, 문제 해결 과정과 회고를 기록했습니다.  
{: .prompt-info}
...
![영어 문제 풀이](/assets/img/project/weasel/english_exam.webp)
...
{% include diagrams/static/project/weasel/weasel-architecture.html %}
{% include diagrams/download.html png="/assets/img/diagrams/static/project/weasel/weasel-architecture--7d7453097efc09b5.png" %}
...
{% include diagrams/static/project/weasel/workflows.html %}
{% include diagrams/download.html png="/assets/img/diagrams/static/project/weasel/workflows--34e59da12b5d501f.png" %}
...
{% include diagrams/download.html png="/assets/img/diagrams/static/project/weasel/cicd--f14b1d4a3bc51cc8.png" %}
...
![alt text](/assets/img/project/weasel/budget_email_improve.jpg)
...
![alt text](/assets/img/project/weasel/slack-jenkins.png)
...
- [github.com - Team S5T1](https://github.com/Team-S5T1)
