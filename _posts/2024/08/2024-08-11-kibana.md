...
{% include diagrams/static/observability/kibana-query-flow.html %}
{% include diagrams/download.html png="/assets/img/diagrams/static/observability/kibana-query-flow--e8a2ab42cc99e77c.png" %}
