...
인증서를 붙이는 절차 자체는 cert-manager가 대신해 주지만, 발급이 실패하거나 브라우저가 경고를 띄울 때 어느 단계에서 막혔는지 읽으려면 handshake가 어떤 순서로 진행되는지 알아야 합니다. TLS의 개념과 인증 과정을 먼저 정리합니다.
...
{% include diagrams/download.html png="/assets/img/diagrams/static/kubernetes/tls-ssl-handshake--04fdb81efe7a615c.png" %}
