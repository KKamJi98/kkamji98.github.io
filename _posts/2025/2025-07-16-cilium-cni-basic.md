...
## eBPF(extended Berkeley Packet Filter) 개념과 장점
...
### 장점 4. 효율적인 서비스 메시 (Service Mesh) 기능
...
## eBPF(extended Berkeley Packet Filter)의 동작방식
...
## Cilium Networking(Routing) Modes
...
### 1. Encapsulation (Tunnel) Mode – VXLAN / Geneve
...
#### Direct Routing (Native) Mode의 장점
...
#### Direct Routing (Native) Mode의 단점
...
## Cilium IPAM(IP Address Management)
