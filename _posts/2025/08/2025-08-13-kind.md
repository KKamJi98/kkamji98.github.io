...
{% include diagrams/static/kubernetes/cilium/5w-kind.html %}
{% include diagrams/download.html png="/assets/img/diagrams/static/kubernetes/cilium/5w-kind--0b9bd512f014f02e.png" %}
...
> **TL;DR**  
> - Kind는 Docker 컨테이너를 노드로 삼아 Kubernetes 클러스터를 띄우므로, VM 없이 멀티 노드 클러스터를 빠르게 만들 수 있습니다.  
> - 필요한 것은 go 1.17 이상과 docker, podman, nerdctl 중 하나, 그리고 kubectl입니다.  
> - 설치 시 `uname -m` 결과에 따라 amd64와 arm64 바이너리를 구분해 받아야 합니다.  
{: .prompt-info}
