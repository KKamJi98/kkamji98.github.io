...
{% include diagrams/static/ci-cd/argocd-multi-cluster-flow.html %}
{% include diagrams/download.html png="/assets/img/diagrams/static/ci-cd/argocd-multi-cluster-flow--6eed5b82f7eb58be.png" %}
