...
![Create Client-1](/assets/img/keycloak/client-1.webp)

> 사진과 같이 Client Type을 OpenID Connect로 설정 후, Client ID, Name을 `ArgoCD` 등으로 지정합니다.
{: .prompt-tip}

![Create Client-2](/assets/img/keycloak/client-2.webp)

> 기본 값인 `Standard Flow`, `Direct Access Grants` 옵션은 그대로 두고 넘어갑니다.
{: .prompt-tip}

![Create Client-3](/assets/img/keycloak/client-3.webp)
...
![ArgoCD Application](/assets/img/keycloak/argocd-applications.webp)  
