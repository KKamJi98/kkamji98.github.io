...
tags: [kubernetes, devops, hubble, hubble-relay, cilium, star-wars, cilium-study, cilium-2w, cloudnet, gasida]     # TAG names should always be lowercase
comments: true
image:
...
> **핵심 정리**  
> - 이 글은 `Star Wars Demo와 함께 Cilium Network Policy 알아보기 [Cilium Study 2주차]`의 개념, 구성 흐름, 실습 결과를 한 번에 따라갈 수 있도록 정리한 글입니다.  
