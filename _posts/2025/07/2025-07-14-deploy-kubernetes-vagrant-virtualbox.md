...
tags: [kubernetes, devops, cilium, vagrant, virtual-box, wsl, cloudnet, gasida, cilium-study, cilium-1w]     # TAG names should always be lowercase
comments: true
image:
...
{% include diagrams/download.html png="/assets/img/diagrams/static/kubernetes/kubernetes_virtualbox_structure--ffeef67eceb5d432.png" %}
...
> **핵심 정리**  
> - 이 글은 `Vagrant와 VirtualBox로 Kubernetes Cluster 구축하기 [Cilium Study 1주차]`의 개념, 구성 흐름, 실습 결과를 한 번에 따라갈 수 있도록 정리한 글입니다.  
