...
지난 글([GitHub Actions 소개 및 구성 요소]({% post_url 2025/2025-05-01-github_actions_basic %}))에서 **GitHub Actions의 기본 개념과 구성 요소**에 대해 살펴보았습니다. 이번에는 **Matrix Strategy**라는 기능에 대해 알아보고 해당 기능을 활용해 여러 플랫폼 또는 환경에서 병렬로 작업을 수행하여 CI/CD 파이프라인의 성능을 향상시키는 방법에 대해 알아보도록 하겠습니다.
...
### 1. Workflow - 단일 러너(amd64), Build & Push Multi-Arch Using QEMU to ECR
...
### 1. 결과 확인 - 단일 러너(amd64), Build & Push Multi-Arch Using QEMU to ECR
...
### 2. Workflow - 다중 러너(amd64, arm64), Build & Push Multi-Arch Using Matrix to ECR
...
### 2. 결과 확인 - 다중 러너(amd64, arm64), Build & Push Multi-Arch Using Matrix to ECR
