...
##### 3.0.0.1 **PV 생성 -> VG 생성 -> LV 생성 -> LV 포맷 -> mount -> /etc/fstab 설정**
...
#### 3.1.1 lvm2 package 다운로드

```
yum -y install lvm2
```

#### 3.1.2 파티션 생성 (sdb, sdc, sdd 모두에 적용)
...
![image](https://github.com/kkamji98/kkamji98.github.io/assets/72260110/fe14231b-5f3c-442f-bf4f-5e2a1ed0371f)
...
#### 3.5.1 /etc/fstab 설정 (vi Editor 사용)
