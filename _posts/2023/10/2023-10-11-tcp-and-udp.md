...
{% include diagrams/static/network/tcp-3-way-handshake.html %}
{% include diagrams/download.html png="/assets/img/diagrams/static/network/tcp-3-way-handshake--114abe5a7b62cb43.png" %}
_세 세그먼트는 순서대로 교환된다. Client가 SYN을 보내고, Server가 SYN+ACK로 답하고, Client가 그 응답을 받은 뒤에 마지막 ACK를 보낸다. 세 번째 세그먼트까지 끝나야 양쪽이 ESTABLISHED가 된다._
