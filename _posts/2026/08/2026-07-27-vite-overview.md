...
{% include diagrams/static/javascript/vite/vite-dev-server-on-demand-transform.html %}
{% include diagrams/download.html png="/assets/img/diagrams/static/javascript/vite/vite-dev-server-on-demand-transform--6de1c5e7a6af07a4.png" %}
