...
운영 중인 마크다운 위키 542개 문서를 Google의 OKF(Open Knowledge Format) 규격으로 재봤습니다. 예상과 달리 어긋나는 지점은 두 개뿐이었습니다. 문서 대부분이 이미 규격을 만족했다는 뜻입니다. 그런데도 OKF를 채택하지 않기로 했습니다. 형식이 안 맞아서가 아니라, 그 형식이 푸는 문제가 제 문제가 아니었기 때문입니다.

---

## 1. OKF가 규정하는 것

OKF는 Google Cloud가 공개한 마크다운 지식 포맷입니다. 계약이 작습니다. SPEC.md 기준으로 정리하면 다음이 전부입니다.
