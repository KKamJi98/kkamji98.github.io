...
![워크로드의 중단 허용도와 약정 가능 기간과 라이선스 단위에서 갈라지는 EC2 구매 옵션 결정 경로](/assets/img/sap-c02/ec2-purchase-option-decision.webp)
...
![요금 할인 수단과 용량 확보 수단이 서로 다른 층에 놓이고 zonal RI만 두 층에 걸치는 구조](/assets/img/sap-c02/capacity-and-discount-layers.webp)
...
![rebalance recommendation과 2분 중단 통지가 각각 이어지는 대응 경로](/assets/img/sap-c02/spot-interruption-signals.webp)
...
![cluster와 partition과 rack-level spread가 각각 Availability Zone 경계에서 어떻게 다르게 놓이는지](/assets/img/sap-c02/placement-group-boundaries.webp)
...
![warm pool에서 시작해 Pending과 InService와 Terminating을 지나는 인스턴스 상태와 lifecycle hook이 개입하는 두 지점](/assets/img/sap-c02/asg-instance-lifecycle-hooks.webp)
