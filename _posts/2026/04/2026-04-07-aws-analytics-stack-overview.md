...
AWS는 이 "S3에 쌓인 데이터를 분석하는 일"을 **여러 서비스의 조합**으로 풉니다. Athena, Glue, S3 Tables, Lake Formation, Redshift가 각자 한 가지 역할을 맡고 맞물려 돌아갑니다. 이 조합, 즉 **AWS 데이터 분석 스택**의 전체 그림을 알아봅니다.
